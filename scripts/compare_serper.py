"""Quick comparison: run the full pipeline with Serper search.

Compare the LangSmith trace with prior Tavily/Brave runs.
Usage: python scripts/compare_serper.py
"""
